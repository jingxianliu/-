                ...
                <el-row>
                    <el-card class="box-card">
                        ...
                        <div class="box">
                            ...
                            <codemirror v-else  v-model="content" :options="mirrorOptions" ></codemirror>
                        </div>
                    </el-card>
                </el-row>
            ...
            <div class="setting-box">
                <div class="setting-item">
                 ...
                 <div class="setting-item">
                    ...
                    <el-col :span="8">
                        <el-select v-model="theme" v-if="editType === 'Monaco'" @change="changeTheme">
                            <el-option label="Visual Studio" value="vs"></el-option>
                            <el-option label="Visual Studio Dark" value="vs-dark"></el-option>
                            <el-option label="GitHub" value="hc-black"></el-option>
                            <!-- <el-option label="xCode" value="vs"></el-option>
                            <el-option label="Material" value="hc-black"></el-option> -->
                        </el-select> 
                        <el-select  v-model="theme" v-else>
                            <el-option label="Textmate" value="vs"></el-option>
                            <el-option label="GitHub" value="vs-dark"></el-option>
                 ...
                 <div class="setting-item">
                    ...
                    <el-col :span="8">
                        <el-select v-model="tabSize" @change="changeTabSize">
                            <el-option label="2个空格" value="2"></el-option>
                            <el-option label="4个空格" value="4"></el-option>
                            <el-option label="8个空格" value="8"></el-option>
                        </el-select> 
                    </el-col>   
                </div>
            </div>   
 ...
 // import monacoEditor from 'vue-monaco-editor'
  ...
  export default {
    ...
    methods:{
        ...
        changeFontSize(val){
            this.fontSize = val
            this.monacoOptions.fontSize = Number(val)
        },
        changeTabSize(val){
            this.tabSize = val 
            this.mirrorOptions.tabSize = Number(val)
        },
